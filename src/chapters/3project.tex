...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.60]{figures/vms.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.60]{figures/lxcs.png}
...
\begin{itemize}
  \item \textbf{Grupy kontroli (cgroups)}.
  Dostarczają mechanizmy grupowania zadań i procesów w hierarchiczne grupy.
  \item \textbf{Przestrzenie nazw (namespaces)}.
  ...
  zasobu.
  \item \textbf{System plików lub rootfs}.

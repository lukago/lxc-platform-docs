...
Kontenery Linux to funkcjonalność jądra Linux umożliwiająca wirtualizację na poziomie jądra systemu.
...
Aplikacja LXD jest zaimplementowana w języku Go, jednak dostarcza interfejs konsolowy, za którego
pomocą została zaimplementowana integracja z kontenerami w projekcie pracy inżynierskiej.
...
Poza ww.\ fikcjonalnościami wchodzącymi w skład tzw.\ rdzenia szkieletu Spring, istnieją również
...
\begin{itemize}
  \item Spring Boot - moduł ułatwiający implementację podczas pracy z wszystkimi modułami
  szkieletu Spring.
  ...
  \item Spring Data - moduł ułatwiający implementację komunikacji z warstwą danych aplikacji, w tym
  ...
  \item Spring Security - moduł odpowiedzialny za zabezpieczenia aplikacji.
  ...
  protokołu HTTPS\@.
  \item Spring Web - moduł umożliwiający tworzenie aplikacji internetowych.

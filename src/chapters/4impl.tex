...
na odpowiedni adres URI dostarczany przez aplikację serwerową.
...
Informacje o statusie przetworzenia zadania stworzenia kontenera, są wysyłanie przez gniazda sieciowe
w technologii WebSocket.
Zostało to zaprezentowane na listingu~\ref{lst:websocat} za pomocą programu \textit{websocat},
które łączy się do zarejestrowanego już kanału w aplikacji serwerowej.
...
Do implementacji tych technologii wykorzystano wiele technologii np.\ szkielet spring czy
bibliotekę JJWT\@.
...
Implementacja tego zabezpieczenia została przedstawiona na listingu~\ref{lst:socketjwt.txt}
...
Z tego powodu warstwa widoku dla administratora wygląda inaczej i posiada inne
funkcje.

\begin{figure}[H]
  \centering
  \includegraphics[scale=0.22]{figures/lxclist.png}
...
Z poziomu tego widoku dodaje się również nowe kontenery.

\begin{figure}[H]
  \centering
  \includegraphics[scale=0.22]{figures/lxcdetails.png}
...
jednak posiada ograniczenia, zgodne z opisem przypadków użycia~\ref{tab:przypadki_uzycia}.
Poniżej zaprezentowano najważniejsze widoki.

\begin{figure}[H]
  \centering
  \includegraphics[scale=0.22]{figures/userhome.png}
...
Warstwa widoku jest dostępna w języku polskim i angielskim.
Przykład działania internacjonalizacji przedstawiono na poniższych
zrzutach z ekranu ze strony logowania~\ref{fig:i18npl} oraz~\ref{fig:i18en}.

\begin{figure}[H]
  \centering
  \includegraphics[scale=0.5]{figures/i18npl.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.5]{figures/i18en.png}

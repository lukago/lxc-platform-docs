...
modułów wchodzących w skład projektu pracy inżynierskiej.
...
Zawartość pliku \textit{docker-compose.yml} dla aplikacji serwerowej została
przedstawiona poniżej we fragmencie programu~\ref{lst:dockercomposeserver}.

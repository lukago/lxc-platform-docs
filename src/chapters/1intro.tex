...
Wiele przedsiębiorstw decyduje się na użycie wspomnianej technologii, ponieważ jest ona bardziej
korzystna pod względem finansowym oraz dostarcza wiele sprawdzonych i gotowych rozwiązań.
...
w tej dziedzinie~\cite{gus:cloud}.
...
czyli model platformy jako usługi, w której zewnętrzny system zarządza całym środowiskiem
aplikacyjnym i udostępnia wybrane usługi użytkownikom.
Prowadzący przedmiotu Systemy Operacyjne na Politechnice Łódzkiej wyrazili zapotrzebowanie
na tego typu system informatyczny, aby ułatwić studentom zarządzanie wieloma systemami operacyjnymi
opartymi o jądro Linux.

\section{Cel i zakres pracy}
\label{sec:cel_zakres}
...
\begin{enumerate}
  ...
  zarządzanego za pomocą narzędzia narzędzia automatyzującego budowę oprogramowania Maven.
  ...
  \item Konfiguracja połączenia między serwerem z aplikacją serwerową a serwerem składującym
  kontenery Linux.
...
\label{sec:dostepne_rozwiazania}
...
Użytkownicy mogą korzystać z tych platform przez przeglądarkę internetową, linię komend lub poprzez
...
\begin{itemize}
  ...
  do aplikacji klienckiej poprzez WebSocket.
  ...
  podłączyć się do niego za pomocą protokołu SSH, z wyłączeniem danych wrażliwych, takich jak hasło.
